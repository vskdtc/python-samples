...
[docs]class GaussianMixtureModel(JavaModel, JavaMLWritable, JavaMLReadable):
    """
...
@inherit_doc
[docs]class GaussianMixture(JavaEstimator, HasFeaturesCol, HasPredictionCol, HasMaxIter, HasTol, HasSeed,
...
[docs]class GaussianMixtureSummary(ClusteringSummary):
    """
    .. note:: Experimental
...
[docs]class KMeansModel(JavaModel, JavaMLWritable, JavaMLReadable):
    """
...
[docs]    def clusterCenters(self):
    ...
    @since("2.0.0")
[docs]    def computeCost(self, dataset):
        """
...
[docs]class BisectingKMeansModel(JavaModel, JavaMLWritable, JavaMLReadable):
    """
...
@inherit_doc
[docs]class BisectingKMeans(JavaEstimator, HasFeaturesCol, HasPredictionCol, HasMaxIter, HasSeed,
                      JavaMLWritable, JavaMLReadable):
    """
    ...
    @keyword_only
    @since("2.0.0")
[docs]    def setParams(self, featuresCol="features", predictionCol="prediction", maxIter=20,
                  seed=None, k=4, minDivisibleClusterSize=1.0):
        """
...
[docs]    def getK(self):
    ...
    @since("2.0.0")
[docs]    def setMinDivisibleClusterSize(self, value):
        """
    ...
    @since("2.0.0")
[docs]    def getMinDivisibleClusterSize(self):
        """
...
[docs]class BisectingKMeansSummary(ClusteringSummary):
    """
    .. note:: Experimental
...
[docs]    def isDistributed(self):
    ...
    @since("2.0.0")
[docs]    def vocabSize(self):
        """Vocabulary size (number of terms or words in the vocabulary)"""
        return self._call_java("vocabSize")

    @since("2.0.0")
[docs]    def topicsMatrix(self):
        """
    ...
    @since("2.0.0")
[docs]    def logLikelihood(self, dataset):
        """
    ...
    @since("2.0.0")
[docs]    def logPerplexity(self, dataset):
        """
    ...
    @since("2.0.0")
[docs]    def describeTopics(self, maxTermsPerTopic=10):
        """
    ...
    @since("2.0.0")
[docs]    def estimatedDocConcentration(self):
        """
...
@inherit_doc
[docs]class DistributedLDAModel(LDAModel, JavaMLReadable, JavaMLWritable):
    """
...
[docs]    def toLocal(self):
    ...
    @since("2.0.0")
[docs]    def trainingLogLikelihood(self):
        """
...
[docs]    def logPrior(self):
    ...
    @since("2.0.0")
[docs]    def getCheckpointFiles(self):
        """
...
@inherit_doc
[docs]class LocalLDAModel(LDAModel, JavaMLReadable, JavaMLWritable):
    """
...
@inherit_doc
[docs]class LDA(JavaEstimator, HasFeaturesCol, HasMaxIter, HasSeed, HasCheckpointInterval,
    ...
    @keyword_only
    @since("2.0.0")
[docs]    def setParams(self, featuresCol="features", maxIter=20, seed=None, checkpointInterval=10,
                  k=10, optimizer="online", learningOffset=1024.0, learningDecay=0.51,
                  subsamplingRate=0.05, optimizeDocConcentration=True,
                  docConcentration=None, topicConcentration=None,
                  topicDistributionCol="topicDistribution", keepLastCheckpoint=True):
...
[docs]    def getK(self):
    ...
    @since("2.0.0")
[docs]    def setOptimizer(self, value):
        """
...
[docs]    def getOptimizer(self):
    ...
    @since("2.0.0")
[docs]    def setLearningOffset(self, value):
        """
    ...
    @since("2.0.0")
[docs]    def getLearningOffset(self):
        """
    ...
    @since("2.0.0")
[docs]    def setLearningDecay(self, value):
        """
    ...
    @since("2.0.0")
[docs]    def getLearningDecay(self):
        """
...
[docs]    def getSubsamplingRate(self):
    ...
    @since("2.0.0")
[docs]    def setOptimizeDocConcentration(self, value):
        """
    ...
    @since("2.0.0")
[docs]    def getOptimizeDocConcentration(self):
        """
    ...
    @since("2.0.0")
[docs]    def setDocConcentration(self, value):
        """
    ...
    @since("2.0.0")
[docs]    def getDocConcentration(self):
        """
    ...
    @since("2.0.0")
[docs]    def setTopicConcentration(self, value):
        """
    ...
    @since("2.0.0")
[docs]    def getTopicConcentration(self):
        """
    ...
    @since("2.0.0")
[docs]    def setTopicDistributionCol(self, value):
        """
    ...
    @since("2.0.0")
[docs]    def getTopicDistributionCol(self):
        """
    ...
    @since("2.0.0")
[docs]    def setKeepLastCheckpoint(self, value):
        """
    ...
    @since("2.0.0")
[docs]    def getKeepLastCheckpoint(self):
        """
